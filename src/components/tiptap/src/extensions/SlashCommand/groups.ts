  ...
  },
  {
    ...
    commands: [
      ...
      },
      {
        ...
        label: "Grid Layout",
        iconName: "LayoutGrid",
        description: "Add grid layout",
        aliases: ["cols"],
        shouldBeHidden: (editor) => editor.isActive("grid"),
        action: (editor) => {
      ...
      },
      {
        ...
        action: (editor) => {
          editor.chain().focus().setCharts().run();
        },
      },
      {
        name: "faq",
