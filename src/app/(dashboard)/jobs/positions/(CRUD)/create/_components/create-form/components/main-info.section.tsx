...
// Create Job Main Info Section

interface Props {
  id: string;
}

const CreateJob_MainInformation_Section = forwardRef<HTMLDivElement, Props>(
  ({ id }, ref) => {
    const {
      control,
    ...
    return (
      <CreationFormSection ref={ref} id={id}>
        <CreationFormSectionInfo>
          ...
          <CreationFormSectionInfoDescription>
            The position title, description, responsibilities, desired profile,
            skills and location
          </CreationFormSectionInfoDescription>
        </CreationFormSectionInfo>
        <CreationFormSectionContent>
...
export default CreateJob_MainInformation_Section;
