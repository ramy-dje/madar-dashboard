...
// Update Job Details Info Section
...
const UpdateJob_Details_Section = forwardRef<HTMLDivElement, Props>(
  ({ id, departments }, ref) => {
    const {
      control,
    ...
    console.log("department :", department_controller.field.value);
        ...
        <CreationFormSectionContent>
          ...
          <div className="flex flex-col col-span-2 md:col-span-1 gap-2">
            ...
            <Select
              ...
              defaultValue={"no"}
              onValueChange={(e) =>
                e && department_controller.field.onChange(e == "no" ? null : e)
              }
            >
              <SelectTrigger
                disabled={disabled}
...
export default UpdateJob_Details_Section;
