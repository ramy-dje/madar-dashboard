...
// Create user account info section
...
const CreateUser_AccountInformation_Section = forwardRef<HTMLDivElement, Props>(
  ({ id, roles }, ref) => {
    const {
...
export default CreateUser_AccountInformation_Section;
