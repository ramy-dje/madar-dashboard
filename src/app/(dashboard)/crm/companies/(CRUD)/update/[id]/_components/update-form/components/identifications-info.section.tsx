...
// Update crm company identifications info section

interface Props {
  id?: string;
}

const UpdateCRMCompany_IdentificationsInformation_Section = forwardRef<
  HTMLDivElement,
  Props
>(({ id }, ref) => {
  const {
...
export default UpdateCRMCompany_IdentificationsInformation_Section;
