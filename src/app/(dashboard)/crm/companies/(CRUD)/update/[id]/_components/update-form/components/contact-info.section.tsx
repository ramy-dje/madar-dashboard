...
// Update crm company info section

interface Props {
  id?: string;
}

const UpdateCRMCompany_ContactInformation_Section = forwardRef<
  HTMLDivElement,
  Props
>(({ id }, ref) => {
  const {
      ...
      <CreationFormSectionContent>
        ...
        <div className="flex flex-col col-span-full w-full gap-2">
          ...
          <FormMultiItemsList
            id="direct-line"
            defaultValuesMount
            defaultValues={old_contact_data.direct_line}
...
export default UpdateCRMCompany_ContactInformation_Section;
