...
import { FaFax, FaWhatsapp, FaViber } from "react-icons/fa6";
import FormMultiItemsList from "@/components/form-multi-items-list";
import { Textarea } from "@/components/ui/textarea";

// Update crm contact info section

interface Props {
  id?: string;
}

const UpdateCRMContact_ContactInformation_Section = forwardRef<
  HTMLDivElement,
  Props
>(({ id }, ref) => {
  const {
  ...
  // old phone number & email data watcher
  const old_contact_data = useWatch({
    control,
    name: "old_phones_numbers_emails",
  });
  ...
  return (
    <CreationFormSection ref={ref} id={id}>
      <CreationFormSectionInfo>
        ...
        <CreationFormSectionInfoDescription>
          The contact info emails ,phone numbers section
        </CreationFormSectionInfoDescription>
      </CreationFormSectionInfo>
      <CreationFormSectionContent>
        ...
        <div className="flex flex-col col-span-2 gap-2">
          ...
          <Textarea
            ...
            disabled={disabled}
            placeholder="Source of this contact"
            {...register("resource", {
              required: true,
            })}
          />
        ...
        <div className="flex flex-col col-span-full w-full gap-2">
          ...
          <FormMultiItemsList
            id="email"
            defaultValuesMount
            defaultValues={old_contact_data.emails}
            placeholder="Email"
            control_name="emails"
            control={control}
            name="Email"
        ...
        <div className="flex flex-col col-span-full w-full gap-2">
          ...
          <FormMultiItemsList
            id="mobile"
            defaultValuesMount
            defaultValues={old_contact_data.mobile}
        ...
        <div className="flex flex-col col-span-full w-full gap-2">
          ...
          <FormMultiItemsList
            id="fax"
            defaultValuesMount
            defaultValues={old_contact_data.fax}
        ...
        <div className="flex flex-col col-span-full w-full gap-2">
          ...
          <FormMultiItemsList
            ...
            defaultValues={old_contact_data.whatsapp}
        ...
        <div className="flex flex-col col-span-full w-full gap-2">
          ...
          <FormMultiItemsList
            id="viber"
            defaultValuesMount
            defaultValues={old_contact_data.viber}
...
export default UpdateCRMContact_ContactInformation_Section;
