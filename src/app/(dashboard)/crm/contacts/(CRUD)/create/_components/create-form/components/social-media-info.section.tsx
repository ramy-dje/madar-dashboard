...
// Create crm contact social media info section

interface Props {
  id?: string;
}

const CreateCRMContact_SocialMediaInformation_Section = forwardRef<
  HTMLDivElement,
  Props
>(({ id }, ref) => {
  const {
...
export default CreateCRMContact_SocialMediaInformation_Section;
